...
/**
 * Contains utility functions for {@link Tensor} creation from {@link Bitmap} or
...
public final class TensorImageUtils {
  ...
  /**
   * Creates new {@link Tensor} from full {@link Bitmap}, normalized with specified
  ...
  /**
   * Creates new {@link Tensor} from specified area of {@link Bitmap}, normalized
